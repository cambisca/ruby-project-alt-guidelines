...
order8 = Order.create(user_id: cam.id, checked_out: true)
order9 = Order.create(user_id: cam.id, checked_out: false)
...
beerorder3 = BeerOrder.create(beer_id: watermelon_glow_up.id, order_id: order2.id)
beerorder4 = BeerOrder.create(beer_id: pacifico.id, order_id: order2.id)
...
beerorder8 = BeerOrder.create(beer_id: logical_conclusion.id, order_id: order3.id)
beerorder9 = BeerOrder.create(beer_id: pacifico.id, order_id: order3.id)
beerorder10 = BeerOrder.create(beer_id: pacifico.id, order_id: order8.id)
beerorder11 = BeerOrder.create(beer_id: budweiser.id, order_id: order9.id)
